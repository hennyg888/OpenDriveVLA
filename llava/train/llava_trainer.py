...
from transformers.trainer import is_sagemaker_mp_enabled, get_parameter_names, has_length, ALL_LAYERNORM_LAYERS, logger, is_accelerate_available, is_datasets_available, GradientAccumulationPlugin, _is_peft_model
...
class LLaVATrainer(Trainer):
    ...
    def create_optimizer(self):
        ...
        if self.optimizer is None:
            ...
            if self.args.mm_projector_lr is not None:
                ...
                lr_mapper["mm_projector_track"] = self.args.mm_projector_lr
                lr_mapper["mm_projector_scene"] = self.args.mm_projector_lr
                lr_mapper["mm_projector_map"] = self.args.mm_projector_lr
    ...
    def _save_checkpoint(self, model, trial, metrics=None):
        if getattr(self.args, "tune_mm_mlp_adapter", False) or (
            ...
            weight_to_save_track = get_mm_adapter_state_maybe_zero_3(self.model.named_parameters(), keys_to_match_track)
            weight_to_save_scene = get_mm_adapter_state_maybe_zero_3(self.model.named_parameters(), keys_to_match_scene)
            weight_to_save_map = get_mm_adapter_state_maybe_zero_3(self.model.named_parameters(), keys_to_match_map)
