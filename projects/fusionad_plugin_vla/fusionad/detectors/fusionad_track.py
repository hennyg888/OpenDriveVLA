...
class FusionADTrack(MVXTwoStageDetector):
    ...
    def extract_img_feat(self, img, len_queue=None):
        ...
        for img_feat in img_feats:
            ...
            # Safety cast: if img_backbone/img_neck ran in float32 for any reason,
            # ensure features enter the bf16 BEV transformer in bf16.
            if img_feat_reshaped.dtype == torch.float32:
                img_feat_reshaped = img_feat_reshaped.bfloat16()
