...
optimizer = dict(
    type="AdamW",
    lr=2e-4,
    paramwise_cfg=dict(custom_keys={"bevfusion.encoder": dict(lr_mult=0.001)}),
    weight_decay=0.01,
)
...
load_from = None
resume_from = "/home/s56cai/OpenDriveVLA/projects/work_dirs/uniad_bevfusion/pretrain_decoder/epoch_6.pth"
