...
optimizer = dict(
    type="AdamW",
    lr=2e-4,
    #paramwise_cfg=dict(custom_keys={"bevfusion.encoders": dict(lr_mult=0.05)}),
    weight_decay=0.01,
)
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name="pretrain_decoder_temporal",
...
load_from = None
resume_from = None #"/home/s56cai/OpenDriveVLA/projects/work_dirs/uniad_bevfusion/pretrain/epoch_1.pth"
