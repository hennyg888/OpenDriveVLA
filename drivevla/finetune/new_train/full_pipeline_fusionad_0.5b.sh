#!/bin/bash
# Full pipeline from Qwen/Qwen2.5-0.5B-Instruct:
#   Stage 1 -> Stage 2 -> (skip Stage 2.5) -> Stage 3 (E2E) -> Inference + Eval.
# All logs / checkpoints / eval results live under
#   output/new_train/<TIMESTAMP>/{stage1,stage2,e2e,eval}.
...
ROOT_OUTPUT_DIR="/home/s56cai/OpenDriveVLA/output/new_train/${TIMESTAMP}"
...
STAGE1_EXPERIMENT_NAME="new_train_stage1_fusionad_0.5b"
...
STAGE2_EXPERIMENT_NAME="new_train_stage2_fusionad_0.5b"
