#!/bin/bash
# Resume the map_debug pipeline starting from the existing Stage 2 checkpoint:
...
#
# No zero-out, no filtering — vanilla training and eval.
#
# Outputs land under a NEW timestamped folder inside
#   /home/s56cai/OpenDriveVLA/output/map_debug/<TIMESTAMP>/
#   {stage25,e2e,eval}/
#
# Launch:
#   bash drivevla/finetune/map_debug/resume_stage25_e2e_eval_fusionad_0.5b.sh
set -e
set -o pipefail
...
PIPELINE_ROOT="/home/s56cai/OpenDriveVLA/output/map_debug"
...
# ---------- [1/3] Stage 2.5 ----------
STAGE25_DATA="/home/s56cai/OpenDriveVLA/data/stage25/stage25_agent_rel_trajectory_train.json"
