#!/bin/bash
# Stage 2: Driving Knowledge Instruction Tuning
# Projectors (from Stage 1) + LLM are trained; vision encoder is frozen.
# Data: NuScenes-QA + nuCaption + NuX
...
# Stage 1 projector weights
STAGE1_CKPT_DIR="/home/s56cai/OpenDriveVLA/output/stage1/stage1_fusionad_0.5b_20260413_160554/fusionad-Qwen2.5-0.5B-stage1_fusionad_0.5b"
...
TRAIN_DATA_PATH="data/stage2/stage2_train.yaml"

TIMESTAMP=$(date +%Y%m%d_%H%M%S)
EXPERIMENT_NAME="stage2_fusionad_0.5b"
OUTPUT_DIR="output/stage2/${EXPERIMENT_NAME}_${TIMESTAMP}"
...
echo "- STAGE1_CKPT:     ${STAGE1_CKPT_DIR}"
