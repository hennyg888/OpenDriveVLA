...
CKPT_PATH="output/0_pretrain/7B/stage3_object_agent_trajectory_on_QA_20250305_022423/uniad-Qwen_Qwen2.5-7B-Instruct-stage3_object_agent_trajectory_on_QA-mm_mlp_adapter,mm_language_model-stage3_object_agent_trajectory_on_QA"
CKPT_PATH_CLEAN="Qwen_Qwen2.5-7B-Instruct"
...
EXPERIMENT_DIR="output/0_ablation/7B_E2E/${TIMESTAMP_BASE}"
