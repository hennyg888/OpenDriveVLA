...
CKPT_PATH="output/0_pretrain/0.5B/stage3_object_agent_trajectory_on_QA_20250304_013305/uniad-Qwen_Qwen2.5-0.5B-Instruct-stage3_object_agent_trajectory_on_QA-mm_mlp_adapter,mm_language_model-stage3_object_agent_trajectory_on_QA"
CKPT_PATH_CLEAN="Qwen_Qwen2.5-0.5B-Instruct"
...
EXPERIMENT_DIR="output/0_ablation/0.5B_E2E/${TIMESTAMP_BASE}"
...
ACCELERATE_CPU_AFFINITY=0 torchrun --nproc_per_node=4 \
