...
def fill_trainval_infos(nusc,
    ...
    for sample in nusc.sample:
        ...
        if not test:
            ...
            info['gt_tokens'] = np.array(sample['anns']) 
...
nusc_can_bus = NuScenesCanBus(dataroot='/workspace/repos/drivevlms.worktrees/planning-oriented/llava-next/uniad/data/nuscenes_full')
...
nusc_infos = fill_trainval_infos(
    nusc, nusc_can_bus, train_scenes, val_scenes, test=False)
