...
class Visualizer:
    ...
    #/home/feng/xuyuan/DriveVLA/drivevlms.worktrees/planning-oriented/llava-next/uniad/data/uniad_results_for_vlm/uniad_e2e_results.pkl
    def _parse_predictions_multitask_pkl(self, predroot):
        ...
        for k in range(len(outputs)):
            ...
            # if token != "b008a79c9b33493ea958075001f1d72a":
            #     continue
